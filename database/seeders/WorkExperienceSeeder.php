...
class WorkExperienceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $work1 = WorkExperience::firstOrCreate(
            ['id' => 1],
            [
                'reference' => generateReference(20),
                'company' => 'Rimsys (Pennsylvania)',
                'title' => 'Senior Software Developer',
                'position' => 'Senior',
                'stack' => 'php,laravel,nodejs',
                'start_year' => Carbon::parse('2022-01-05'),
                'end_year' => Carbon::now(),
                'till_present' => true,
                'image_url' => 'rimsys.png',
            ]
        );
        Achievement::firstOrCreate(
            ...
            [
                'reference' => generateReference(20),
                'work_experience_id' => $work1->id,
                'title' => 'Improve and optimize code base',
                'description' => 'Collaborated with other engineers to improve and optimze the code base'
            ]
        );
        ...
        Achievement::firstOrCreate(
            ...
            [
                ...
                'description' => 'Integrated the application with sisense analytics to provide insight to our customers'
            ]
        );
        ...
        Achievement::firstOrCreate(
            ...
            [
                'reference' => generateReference(20),
                'work_experience_id' => $work1->id,
                'title' => 'Improve Devliverables',
                'description' => 'Collaborated with a team of engineers deliver clean and quality software in a fast pace workspace'
            ]
        );
        ...
        $work2 = WorkExperience::firstOrCreate(
            ...
            [
                ...
                'end_year' => Carbon::parse('2021-12-01'),
                'till_present' => false,
        ...
        Achievement::firstOrCreate(['id' => 15],
            [
                'reference' => generateReference(20),
                'work_experience_id' => $work3->id,
        ...
        $work5 = WorkExperience::firstOrCreate(
            ['id' => 5],
            [
                'reference' => generateReference(20),
                'company' => 'Tutor.Ng',
