...
```bash
 git clone https://github.com/chis0m/laranuxt.git && cd laranuxt && ./setup.sh
```
> *Note:* 
...
> **Note:**
> respectively phpcbf | phpcs | phpstan
...
* TL;DR
 ```bash
git clone https://github.com/chis0m/laranuxt.git && cd laranuxt; yarn; composer install; cp .env.example .env; ./artisan serve; yarn dev
 ```
* If not using docker set API_URL=http://127.0.0.1:8000 in the .env file
